...
public class Bonsly_Abyss_Blast_Entity extends Entity {
    ...
    private static final EntityDataAccessor<Float> YAW = SynchedEntityData.defineId(Bonsly_Abyss_Blast_Entity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> PITCH = SynchedEntityData.defineId(Bonsly_Abyss_Blast_Entity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> DURATION = SynchedEntityData.defineId(Bonsly_Abyss_Blast_Entity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> CASTER = SynchedEntityData.defineId(Bonsly_Abyss_Blast_Entity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> BEAMDIRECTION = SynchedEntityData.defineId(Bonsly_Abyss_Blast_Entity.class, EntityDataSerializers.FLOAT);
    ...
    public Bonsly_Abyss_Blast_Entity(EntityType<? extends Bonsly_Abyss_Blast_Entity> type, Level world) {
        super(type, world);
        noCulling = true;
    ...
    public Bonsly_Abyss_Blast_Entity(EntityType<? extends Bonsly_Abyss_Blast_Entity> type, Level world, LivingEntity caster, double x, double y, double z, float yaw, float pitch, int duration, float direction) {
        this(type, world);
        this.caster = caster;
        this.setYaw(yaw);
        this.setPitch(pitch);
    ...
    private void spawnExplosionParticles(int amount) {
        for (int i = 0; i < amount; i++) {
            ...
            // Green particles for Bonsly
            level().addParticle((new LightningParticle.OrbData(34, 139, 34)), collidePosX, collidePosY + 0.1, collidePosZ, motionX, motionY, motionZ);
        }
