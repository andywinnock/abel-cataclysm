...
@OnlyIn(Dist.CLIENT)
public class Bonsly_Abyss_Blast_Renderer extends EntityRenderer<Bonsly_Abyss_Blast_Entity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Cataclysm.MODID,"textures/entity/bonsly_laser_beam.png");
    ...
    public Bonsly_Abyss_Blast_Renderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }

    @Override
    public ResourceLocation getTextureLocation(Bonsly_Abyss_Blast_Entity entity) {
        return TEXTURE;
    }


    public boolean shouldRender(Bonsly_Abyss_Blast_Entity solarBeam, Frustum camera, double camX, double camY, double camZ) {
        return true;
    }

    @Override
    public void render(Bonsly_Abyss_Blast_Entity solarBeam, float entityYaw, float delta, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    public void drawVertex(Matrix4f matrix, Matrix3f normals, VertexConsumer vertexBuilder, float offsetX, float offsetY, float offsetZ, float textureX, float textureY, float alpha, int packedLightIn) {
        vertexBuilder
                ...
                .color(1, 1, 1, 1 * alpha) // White color to show natural texture colors
