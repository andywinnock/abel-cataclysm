...
public class CMModelLayers {
    ...
    public static final ModelLayerLocation SEEDOT_MODEL = createLocation("seedot_model", "main");
    public static final ModelLayerLocation LABUBU_MODEL = createLocation("labubu_model", "main");
    ...
    public static void register(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(SEEDOT_MODEL, Seedot_Model::createBodyLayer);
        event.registerLayerDefinition(LABUBU_MODEL, Labubu_Model::createBodyLayer);
